...
import { DevDocs } from '../../features/dev-docs';
                    ...
                    <main className="main">
                        ...
                        <Container fluid>
                            <Switch>
                                ...
                                <Route exact path="/dev-docs" name="DevDocs" component={DevDocs}/>
                                ...
                                <Route path="/icons/social-buttons" name="Social Buttons" component={SocialButtons}/>
